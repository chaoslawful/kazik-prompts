...
**触发场景**：用户的问题涉及多个专业领域，需要多学科互补视角协同分析，而非单一专家意见。
...
**触发场景**：用户的问题被路径依赖和表面修补困住，需要回归本质推倒重来。适合改组织流程、做产品架构、修复杂系统等。
...
**触发场景**：用户的问题在本行业内难以解决，希望从其他领域寻找已被验证的类似解法，获得新视角。
...
然后从历史案例，以及至少3个彼此距离较远的领域中寻找类似解法。
