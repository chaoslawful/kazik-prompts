...
**触发场景**：用户要理解一个完全陌生的概念或问题，需要从小白和专家两个角度建立理解。
...
**触发场景**：用户看到一个优秀的作品（产品页面、网页、方案、流程、数据看板等），想学习它为什么有效。
...
**触发场景**：用户需要对某个陌生领域、产品、公司、人物、技术或事件做深度系统研究。建议配合AI的深度研究功能使用以获得最佳效果。
...
**触发场景**：用户需要验证某个观点、结论、数据或方案的真实性，或需要审查AI/人类输出的可信度。
